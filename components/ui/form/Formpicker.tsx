...
export const Formpicker = ({
    ...
    const [image, setImage] = useState<Array<Record<string,any>>>([defaultImages]);
                        ...
                        >
                            ...
                            />
                            {
                                selectedImageId === image.id && (
                                    <div className="absolute inset-y-0 flex items-center justify-center h-full w-full bg-black/30">
